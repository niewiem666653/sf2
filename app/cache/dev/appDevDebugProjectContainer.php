...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'components_gallery.file_manager.list_file' => 'getComponentsGallery_FileManager_ListFileService',
    ...
    /**
     * Gets the 'components_gallery.file_manager.list_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Components\GalleryBundle\FileManager\ListFile A Components\GalleryBundle\FileManager\ListFile instance.
     */
    protected function getComponentsGallery_FileManager_ListFileService()
    {
        return $this->services['components_gallery.file_manager.list_file'] = new \Components\GalleryBundle\FileManager\ListFile($this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf2_components', 'user' => 'root', 'password' => 'dupa1234', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Components/GalleryBundle/Entity'))), 'Components\\GalleryBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ComponentsGalleryBundle' => 'Components\\GalleryBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4209c00579ab0df9b9ae261544f90b5445fdee4886d34e0620011d5a188602f6');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Components/GalleryBundle/Resources/views'), 'ComponentsGallery');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c3419f2f6821f98268da87a3b2cb18f05bd53ca0');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ComponentsGalleryBundle' => 'Components\\GalleryBundle\\ComponentsGalleryBundle',
            ...
            'locale' => 'pl',
            'secret' => 'c3419f2f6821f98268da87a3b2cb18f05bd53ca0',
            ...
            'kernel.secret' => 'c3419f2f6821f98268da87a3b2cb18f05bd53ca0',
