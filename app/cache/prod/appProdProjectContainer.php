...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'components_gallery.upload_listener' => 'getComponentsGallery_UploadListenerService',
    ...
    protected function getComponentsGallery_UploadListenerService()
    {
        return $this->services['components_gallery.upload_listener'] = new \Components\GalleryBundle\EventListener\UploadListener($this->get('doctrine'));
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sf2_components', 'user' => 'root', 'password' => 'dupa1234', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d92fe8c7d26e1ae880b90d39bb0100bb3f21863bb1e312cf7b7a2eae8e98efe3');
        return $instance;
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'components_gallery.upload_listener', 1 => 'onUpload'), 0);
