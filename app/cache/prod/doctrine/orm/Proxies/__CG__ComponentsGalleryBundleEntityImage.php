 ...
 */
class Image extends \Components\GalleryBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'gallery', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'title', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'slug', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'description', '' . "\0" . 'Components\\GalleryBundle\\Entity\\Image' . "\0" . 'sequence');
        }
